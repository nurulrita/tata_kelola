...
urlpatterns =[
    ...
    url(r'^proyek_dashboard/$', TemplateView.as_view(template_name="tatakelola/proyek_dashboard_diskominfo.html"), {}, 'proyek_dashboard'),
    url(r'^kebijakan_dashboard/$', TemplateView.as_view(template_name="tatakelola/kebijakan_dashboard_diskominfo.html"), {}, 'kebijakan_dashboard'),
    url(r'^kebijakan/$', views.kebijakan, {'template_name': 'tatakelola/kebijakanform.html'}, 'kebijakan'),
    url(r'^evaluasiMonitoring_dashboard/$', TemplateView.as_view(template_name="tatakelola/em_dashboard_diskominfo.html"), {}, 'evaluasiMonitoring_dashboard'),
    url(r'^evaluasipertahun/$', TemplateView.as_view(template_name="tatakelola/evaluasipertahun_diskominfo.html"), {}, 'evaluasipertahun'),
    url(r'^monitoring/$', views.monitor, {'template_name': 'tatakelola/monitor_diskominfo.html'}, 'monitoring'),
